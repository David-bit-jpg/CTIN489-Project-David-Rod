    ...
    public static class MLSEditorUtils
    {
        ...
        public static void DrawBlendingConfigurator(MagicLightmapSwitcher activeSwitcherSource, StoredLightingScenario storedLightingScenario)
        {
            ...
            using (new GUILayout.HorizontalScope())
            {
                ...
                storedLightingScenario.randgesSettingMode = (StoredLightingScenario.RandgesSettingMode)
                                EditorGUILayout.EnumPopup(storedLightingScenario.randgesSettingMode, GUILayout.MaxWidth(300));
            }
            ...
            using (new GUILayout.VerticalScope(GUI.skin.box))
            {
                ...
                if (storedLightingScenario.stopPreviewPlayback)
                {
                    ...
                    if (storedLightingScenario.prevBlendValue != storedLightingScenario.globalBlendFactor)
                    {
                        ...
                        for (int j = 0; j < storedLightingScenario.blendableLightmaps.Count; j++)
                        {
                            ...
                            if (j > 0)
                            {
                                ...
                                if (EditorGUI.EndChangeCheck())
                                {
                                    ...
                                    {
                                        switch (storedLightingScenario.randgesSettingMode)
                                        {
                                            case StoredLightingScenario.RandgesSettingMode.Copy:
                                                ...
                                                break;
                                            case StoredLightingScenario.RandgesSettingMode.Mirror:
                                                storedLightingScenario.blendableLightmaps[storedLightingScenario.blendableLightmaps.Count - j].
